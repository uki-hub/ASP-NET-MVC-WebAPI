...
namespace V7_API_BASE.Models 
                                {public class HEM108
                                {
                                    ...
                                    public string dirmname { get; set; }
                                
                                    public string dirlname { get; set; }
                                
                                    public DateTime? dtregist { get; set; }
                                
                                    public string registnm { get; set; }
                                
                                    public string registpos { get; set; }
                                
                                    public string rregist { get; set; }
                                
                                    public string cpname { get; set; }
                                
                                    public string cpemail { get; set; }
                                
                                    public string cppayname { get; set; }
                                
                                    public string cppayemail { get; set; }
                                
                                    public string bnfcname { get; set; }
                                    ...
                                    public string bbranchnm { get; set; }
                                
                                    public string bankaccnum { get; set; }
                                
                                    public string bankswcd { get; set; }
